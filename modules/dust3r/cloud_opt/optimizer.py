...
class PointCloudOptimizer(BasePCOptimizer):
    ...
    def __init__(self, *args, optimize_pp=False, focal_break=20, **kwargs):
        ...
        self._stacked_pred_i = ParameterStack(self.pred_i, self.str_edges, is_param=True, fill=self.max_area)
        self._stacked_pred_j = ParameterStack(self.pred_j, self.str_edges, is_param=True, fill=self.max_area)
